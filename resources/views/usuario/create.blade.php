<form method="POST" id="form-registro" action="{{ route('usuario.store') }}" class="form">
    @csrf
    <div class="form-group row">
        ...
        <div class="col-md-8" id="c_dni_user">
            <input type="text" class="form-control" placeholder="Ingrese DNI Usuario"
                   id="dni_user" name="dni_user" maxlength="8">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        <label class="col-md-4 col-form-label">Repite Contrase&ntilde;a</label>
        <div class="col-md-8">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <label>
                <input type="checkbox" id="moto_user" id="moto_user" name="moto_user">
                Moto
            </label>
        </div>
    </div>
